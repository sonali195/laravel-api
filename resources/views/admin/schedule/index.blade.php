...
<div class="row page-title align-items-center">
    <div class="col-sm-6 col-xl-6">
        <h4 class="mb-1 mt-0 font-weight-medium">Schedule</h4>
    </div>
    <div class="col-sm-auto ml-auto">
        <a href="{{ route('admin.schedule.create') }}"><button type="button" class="btn btn-primary text-white"> Add New Schedule</button></a>
    </div>
</div>
@endsection
...
<script type="text/javascript">
    var filter_url = "{{ route('admin.schedule.records') }}";
    var delete_url = "{{ route('admin.schedule.destroy', ['schedule' => 'scheduleid']) }}";
</script>
