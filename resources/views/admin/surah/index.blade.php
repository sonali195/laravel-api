...
<div class="row page-title align-items-center">
    <div class="col-sm-6 col-xl-6">
        <h4 class="mb-1 mt-0 font-weight-medium">All Surah</h4>
    </div>
    <div class="col-sm-auto ml-auto">
        <a href="{{ route('admin.surah.create') }}"><button type="button" class="btn btn-primary text-white"> Add New Surah</button></a>
    </div>
</div>
@endsection
...
<script type="text/javascript">
    var filter_url = "{{ route('admin.surah.records') }}";
    var delete_url = "{{ route('admin.surah.destroy', ['surah' => 'surahid']) }}";
</script>
...
<script defer src="{{ Helper::assets('assets/js/pages/admin/surah.js') }}?v={{config('constant.asset_version')}}" type="text/javascript"></script>
@endsection
